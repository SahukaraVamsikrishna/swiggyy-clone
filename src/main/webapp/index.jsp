...
<head>
    ...
    <title>Swiggy - Food Delivery</title>
...
<body>
    ...
    <!-- Navbar -->
    <header>
        <img src="assets/logo.png" alt="Swiggy Logo">
        <nav>
            <ul>
                <li><a href="#">Home</a></li>
    ...
    <section class="hero">
        ...
        <p>Fast delivery | Best prices | Tasty food</p>
    ...
    <!-- Footer -->
    <footer>
        <p>© 2025 swiggyy Clone. All rights reserved.</p>
    </footer>
